...
int main(int argc, char** argv)
{
	...
	printf("accelerometer=%p Vendor=(%s)\n",
            accelerometer, accelerometer->getVendor().string());
	printf("accelerometer=%p type=(%d)\n",
            accelerometer, accelerometer->getType());
	printf("accelerometer=%p Version=(%d)\n",
            accelerometer, accelerometer->getVersion());
